 ...
 * @version 0.1
 */
public class TouchesBuffered {

    private final long timestamp; // timestamp when data collected
    ...
    public TouchesBuffered(String line) {
    ...
    /**
     * Returns the timestamp of the collected event
